/* OPTYKER_CASH_RECEIPT_SEPARATION_V1 */
(function(){
'use strict';
if(window.OPTYKER_CASH_RECEIPT_SEPARATION_V1)return;
window.OPTYKER_CASH_RECEIPT_SEPARATION_V1='20260914-rch-local1';
...
function label(){
  ...
  if(help&&help.closest('.optykerCashCheckout'))help.innerHTML='<b>Vendita Optyker + scontrino fisico RCH.</b> Questa operazione non crea ordini Shopify. Gli ordini online restano separati nel modulo Ordini.';
}
