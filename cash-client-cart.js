...
function clientCartLockUi(){
  ...
  box.querySelectorAll('[data-minus^="client_cart:"],[data-plus^="client_cart:"],[data-remove^="client_cart:"]').forEach(function(b){b.disabled=true;b.title='Voce generata da una Busta ordinata. Togli la spunta per pagarla in seguito.'});
...
var clientCartNativeRemove=removeLine;removeLine=function(id){if(S.busy||S.clientCartLoading||S.clientCartError||clientCartHasPending()||String(id||'').indexOf('client_cart:')===0)return;var r=clientCartNativeRemove.apply(this,arguments);clientCartSchedule();return r};
