...
VERSION='20260916-admin-cash5'
page=SITE/'index.html'
h=page.read_text(encoding='utf-8')
if 'billing-admin.js' not in h:
    raise SystemExit('Admin cash closure: billing administration loader missing')
for marker in ('optykerAdminCashClosureCss','optykerAdminCashTodayCss','optykerAdminCashClosureJs','optykerAdminCashTodayJs','optykerAdminCashRchRecoveryJs'):
...
release={
    ...
    'features':['admin_opening','daily_closure','turnover_vs_paid','automatic_receipt_count','monthly_paid_total','today_open_button','today_close_button','carry_forward_cash_fund','rch_daily_closure','rch_closure_recovery'],
