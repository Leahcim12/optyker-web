...
required_app13=['<h1>Orari</h1>','data-nav="hours"','data-nav="timer"','push_subscribe','timer_create','APP 13.1','sw.js?v=13','profile_photo_save','chooseChatProfilePhoto','attachment_data','chatImageModal']
