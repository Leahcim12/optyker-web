...
required_app13=['<h1>Orari</h1>','data-nav="hours"','data-nav="timer"','push_subscribe','timer_create','APP 13.4','sw.js?v=20260903-app-live1',"const OPTYKER_BUILD='20260903-app-live1'",'profile_photo_save','chooseChatProfilePhoto','attachment_data','chatImageModal']
