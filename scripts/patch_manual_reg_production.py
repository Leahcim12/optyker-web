...
def patch_loader():
    ...
    line = "    if(!html.includes('rch-cloud-relay.js?v=20260916-manualreg2&clickfix=1'))html=html.replace('</body>','<script src=\"/rch-cloud-relay.js?v=20260916-manualreg2&clickfix=1\"><\\/script></body>');\n"
    if 'rch-cloud-relay.js?v=20260916-manualreg2&clickfix=1' not in s:
        if marker not in s:
