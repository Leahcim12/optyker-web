...
try{
 ...
 const cell=page.locator('[data-ovc-default-id="'+ids[0]+'"]');assert((await cell.innerText()).includes('40,00'));assert((await page.locator('.whServiceTable thead').innerText()).includes('Prezzo OVC Card predefinito'));report.checks.push('Default price column and direct edit buttons are visible in real Services table');
